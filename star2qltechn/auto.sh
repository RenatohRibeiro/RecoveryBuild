...
wget https://gitlab.com/OrangeFox/device/star2qltechn/-/raw/fox-8.1/OrangeFoxBuild.sh
sudo chmod +x OrangeFoxBuild.sh
git clone https://gitlab.com/OrangeFox/device/star2qltechn device/samsung/star2qltechn
